...
for text in paragraphs:
    if(parentID[i] != -2):
        try:
            wr.writerow((i, alljobs[i-offset1], dataset_values[datai-offset2], dataset_values[datai+1-offset2],
            dataset_values[datai+2-offset2], dataset_values[datai+3-offset2], dataset_values[datai+4-offset2],
            dataset_values[datai+5-offset2], parentID[i]))
        except:
